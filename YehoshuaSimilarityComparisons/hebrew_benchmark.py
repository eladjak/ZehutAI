...
via :func:`embeddings_comparison.compare_sentences`.
...
def _run_benchmark_summary(model_name: str | None = None) -> dict[str, Any]:
    ...
    """
    from embeddings_comparison import compare_sentences  # local import for testability
...
def run_benchmark(
    ...
    **New (summary-dict) style** – for evaluating against
    :data:`HEBREW_SENTENCE_PAIRS` via :func:`embeddings_comparison.compare_sentences`:
